...
var Ro = new er({ locale: [
	{
		...
		location: {
			...
			street_pattern: ["{{location.street_suffix}} {{location.street_name}}", "{{location.street_name}} {{location.street_suffix}}"],
			street_suffix: [
				"аллея",
				"ал.",
				"набережная",
		...
		person: {
			...
			last_name_pattern: {
				female: [{
					value: "{{person.last_name.female}}",
					weight: 1
				}],
				male: [{
					value: "{{person.last_name.male}}",
					weight: 1
				}]
			},
			middle_name: {
...
//# sourceMappingURL=@faker-js_faker_locale_ru.js.map